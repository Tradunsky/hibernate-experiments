...
@Slf4j
public class MonitorablePersistentBag 
        extends AbstractMonitorablePersistentCollection 
        implements
//        UserCollectionType,
        List {
//
...
//        return new MonitorablePersistentBag();
//    }
    ...
    /**
     * Constructs a MonitorablePersistentBag.  Needed for SOAP libraries, etc
     */
    @SuppressWarnings("UnusedDeclaration")
    public MonitorablePersistentBag() {
    }

    /**
     * Constructs a MonitorablePersistentBag
     *
     * @param session The session
     */
    public MonitorablePersistentBag(SharedSessionContractImplementor session) {
        super( session );
    }
    ...
    public MonitorablePersistentBag(SharedSessionContractImplementor session, Collection coll) {
        super( session );
    ...
    public Iterator iterator() {
        read();
        return new AbstractMonitorablePersistentCollection.IteratorProxy( bag.iterator() );
    }
    ...
    public boolean add(Object object) {
        if ( !isOperationQueueEnabled() ) {
            ...
            queueOperation( new MonitorablePersistentBag.SimpleAdd( object ) );
            return true;
        }
    }
    ...
    public boolean addAll(Collection values) {
        ...
        if ( !isOperationQueueEnabled() ) {
            ...
            for ( Object value : values ) {
                queueOperation( new MonitorablePersistentBag.SimpleAdd( value ) );
            }
    ...
    public void clear() {
        if ( isClearQueueEnabled() ) {
            queueOperation( new MonitorablePersistentBag.Clear() );
        }
        else {
            initialize( true );
            if ( ! bag.isEmpty() ) {
    ...
    public ListIterator listIterator() {
        read();
        return new AbstractMonitorablePersistentCollection.ListIteratorProxy( bag.listIterator() );
    }
    ...
    public ListIterator listIterator(int i) {
        read();
        return new AbstractMonitorablePersistentCollection.ListIteratorProxy( bag.listIterator( i ) );
    }
    ...
    public List subList(int start, int end) {
        read();
        return new AbstractMonitorablePersistentCollection.ListProxy( bag.subList( start, end ) );
    }
    ...
    protected SharedSessionContractImplementor openTemporarySessionForLoading() {
        ...
        SharedSessionContractImplementor sharedSessionContractImplementor = super.openTemporarySessionForLoading();
        log.warn("Temporary session opening took: {}ns.", stopwatch.elapsed(TimeUnit.NANOSECONDS));
        return sharedSessionContractImplementor;
    }

    final class Clear implements AbstractMonitorablePersistentCollection.DelayedOperation {
        @Override
        public void operate() {
            bag.clear();
        }
    ...
    final class SimpleAdd extends AbstractMonitorablePersistentCollection.AbstractValueDelayedOperation {
